...
from config.structure import NetworkParams
from model.modules import round_filters, round_repeats
...
class BlockParams:
    ...
    def update_block(self, input_filters, output_filters, num_repeat, network_params: NetworkParams):
